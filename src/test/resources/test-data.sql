...
DELETE FROM users;
INSERT INTO users (id, first_name, last_name, genre, birth_date, bio, email, password, role_id, is_active, phone_number) VALUES (1,'default','user','M','1981-01-01','teacher','default_user@gmail.com','password',1,true,'333-2122454');